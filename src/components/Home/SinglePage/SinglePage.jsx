...
import seo1 from '../../../images/servicesImg/SocialMedia/seo1.jpg'
import seo2 from '../../../images/servicesImg/SocialMedia/seo2.jpg'
import seo3 from '../../../images/servicesImg/SocialMedia/seo3.png'
...
import d3 from '../../../images/servicesImg/DigitalMarketing/d3.jpg'
...
{/* -------------------------------------SEO Services-------------------------------------------------- */}
      <div className="flex flex-col-reverse bg-white items-center justify-between px-[2rem] md:px-[4rem] py-[4rem] md:flex md:flex-row  md:justify-between ">
        <div className=" md:w-[50%] py-2 ">
          <div className="space-y-5">
            <h3 className=" m-auto  text-[2rem] text-center font-semibold text-red-600">
              <Slide> SEO Services</Slide>
            </h3>
            
              <Slide>
              <p className="text-gray-600 m-auto md:w-[80%] text-center md:text-[1.2rem]">
              Reach the pinnacle of search rankings and be the brand audiences
              trust.
              </p>
              </Slide>
        ...
        <div className="md:w-[50%] ">
          ...
          <div className="md:flex hidden">
            <div className="lg:w-[50%] h-[14rem]  object-cover p-2">
              <Slide className=" object-cover w-full h-full">
              <img src={seo2} className=" object-cover w-full h-full" />
              </Slide>
              
            </div>
            <div className="lg:w-[50%] h-[14rem] md:w-[120%] p-2">
            <Slide className=" object-cover w-full h-full">
              <img src={seo3} className=" object-cover w-full h-full" />
              </Slide>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse bg-white items-center justify-between px-[2rem] md:px-[4rem] py-[4rem] md:flex md:flex-row  md:justify-between ">
        ...
        <div className="md:w-[50%] ">
          ...
          <div className="md:flex hidden">
            ...
            <div className="lg:w-[50%] h-[14rem] md:w-[120%] p-2">
              <Slide className="w-full h-full">
                <img src={d3} className="w-full h-full" />
              </Slide>
            </div>
          </div>
